...
export const Demo: React.FC = () => {
  ...
  const createInstance = () => {
    if (instances.length >= 3) {
      setLogs(prev => [...prev, "> Max 3 instances allowed for demo"]);
      return;
    }
    const newInstance = { id: nextId, count: 0 };
    setInstances(prev => [...prev, newInstance]);
    setNextId(prev => prev + 1);
    setLogs(prev => [...prev, `> Counter c${nextId} = new Counter();`]);
  };
  ...
  const incrementInstance = (id: number) => {
    ...
    setLogs(prev => [...prev, `> c${id}.count++; // Instance variable: ${instances.find(i => i.id === id)?.count! + 1}`]);
  ...
  const incrementStatic = () => {
    ...
    setLogs(prev => [...prev, `> Counter.globalCount++; // Static variable: ${globalCount + 1}`]);
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <div className="flex flex-wrap gap-4 items-center bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        ...
        >
          <Plus size={18} /> Counter.globalCount++
        </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Visualization Area */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[400px] flex flex-col relative overflow-hidden bg-grid-slate-100">
          
          {/* Method Area (Static) */}
          <div className="mb-8">
            <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Method Area (Static Memory)</div>
            <motion.div 
            ...
            >
              ...
              <div>
                <div className="text-xs text-purple-600 font-mono">static int globalCount</div>
          ...
          <div className="flex-1 bg-gray-50 rounded-xl border border-dashed border-gray-300 p-4">
            <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4">Heap Memory (Instances)</div>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-blue-50 p-2 rounded-lg border border-blue-100">
                        <div className="text-xs text-blue-600 font-mono mb-1">int count</div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-gray-900 rounded-xl shadow-lg p-4 font-mono text-sm overflow-hidden">
            ...
            <div className="space-y-1 text-gray-300">
              <div className="text-gray-500">// Static vs Instance Members</div>
