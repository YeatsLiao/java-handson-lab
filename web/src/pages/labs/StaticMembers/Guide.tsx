...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Comparative Analysis</h3>
      <div className="overflow-x-auto">
        <table className="min-w-full text-sm text-left text-gray-600 border border-gray-200 rounded-lg">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              <th className="px-6 py-3 border-b">Feature</th>
              <th className="px-6 py-3 border-b">Instance Variable</th>
              <th className="px-6 py-3 border-b">Static Variable</th>
            </tr>
          </thead>
          <tbody>
            <tr className="bg-white border-b">
              <td className="px-6 py-4 font-medium text-gray-900">Belongs to</td>
              <td className="px-6 py-4">Specific Object</td>
              <td className="px-6 py-4">Class</td>
            </tr>
            <tr className="bg-white border-b">
              <td className="px-6 py-4 font-medium text-gray-900">Memory Location</td>
              <td className="px-6 py-4">Heap Memory</td>
              <td className="px-6 py-4">Method Area / Metaspace</td>
            </tr>
            <tr className="bg-white border-b">
              <td className="px-6 py-4 font-medium text-gray-900">Copies</td>
              <td className="px-6 py-4">Each object has an independent copy</td>
              <td className="px-6 py-4">All objects share the same copy</td>
            </tr>
            <tr className="bg-white">
              <td className="px-6 py-4 font-medium text-gray-900">Lifecycle</td>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Common Uses</h3>
      <ul className="list-disc list-inside text-gray-600 space-y-1 mb-4">
