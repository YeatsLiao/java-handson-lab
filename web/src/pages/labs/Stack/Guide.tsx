...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">What is Method Call Stack?</h3>
      <p className="text-gray-600 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Recursion and StackOverflow</h3>
      <p className="text-gray-600 mb-2">
