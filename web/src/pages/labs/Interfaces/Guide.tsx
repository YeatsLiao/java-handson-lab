...
const GuideZh: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">接口的作用</h3>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">生活中的类比</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">面向接口编程</h3>
...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Role of Interfaces</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Real-world Analogy</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Programming to Interfaces</h3>
      <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto border border-gray-700">
        <pre>{`interface USB {
    void work();
}
