...
const GuideZh: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">ArrayList 内部原理</h3>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">核心属性</h3>
      <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2 mb-4">
        <li>
          <strong>elementData:</strong> 
          <code className="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-sm mx-1">Object[]</code>
          底层存储元素的数组。
        </li>
        <li>
          <strong>size:</strong> 
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">扩容机制 (Resizing)</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">ArrayList Internal Principles</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Core Attributes</h3>
      <ul className="list-disc list-inside text-gray-600 dark:text-gray-400 space-y-2 mb-4">
        <li>
          <strong>elementData:</strong> 
          <code className="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-sm mx-1">Object[]</code>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Resizing Mechanism</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
