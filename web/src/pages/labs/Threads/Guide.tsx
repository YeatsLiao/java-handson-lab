...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Thread Lifecycle</h3>
      <p className="text-gray-600 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Six States (Enum Thread.State)</h3>
      <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Common State Transitions</h3>
      <table className="min-w-full text-sm text-left text-gray-600 border border-gray-200 rounded-lg">
        <thead className="text-xs text-gray-700 uppercase bg-gray-50">
          <tr>
            <th className="px-6 py-3 border-b">Current State</th>
            <th className="px-6 py-3 border-b">Action/Event</th>
            <th className="px-6 py-3 border-b">Target State</th>
          </tr>
        </thead>
        <tbody>
          <tr className="bg-white border-b">
