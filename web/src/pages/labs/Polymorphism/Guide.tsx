...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Inheritance and Polymorphism</h3>
      <p className="text-gray-600 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Key Mechanisms</h3>
      <ul className="list-disc list-inside text-gray-600 space-y-2 mb-4">
        <li>
        ...
        <li>
          ...
          When calling <code className="bg-gray-100 px-1 py-0.5 rounded text-sm mx-1">s.draw()</code>,
