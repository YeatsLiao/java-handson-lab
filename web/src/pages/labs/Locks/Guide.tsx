...
const GuideZh: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">线程安全问题</h3>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Synchronized 关键字</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">代码对比</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <h4 className="font-bold text-red-600 dark:text-red-400 mb-2">不安全 (Unsafe)</h4>
    ...
    void increment() {
        ...
        <div>
          <h4 className="font-bold text-green-600 dark:text-green-400 mb-2">安全 (Synchronized)</h4>
          <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto border border-gray-700">
            <pre>{`class Counter {
    int count = 0;
...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Thread Safety Issues</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Synchronized Keyword</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Code Comparison</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <h4 className="font-bold text-red-600 dark:text-red-400 mb-2">Unsafe</h4>
          <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto border border-gray-700">
            <pre>{`class Counter {
    int count = 0;
    ...
    void increment() {
        ...
        <div>
          <h4 className="font-bold text-green-600 dark:text-green-400 mb-2">Safe (Synchronized)</h4>
          <div className="bg-gray-900 text-gray-100 p-4 rounded-lg font-mono text-sm overflow-x-auto border border-gray-700">
            <pre>{`class Counter {
    int count = 0;
