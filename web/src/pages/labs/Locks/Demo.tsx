      ...
      <div className="flex flex-col md:flex-row items-center gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          >
            ...
            {isLocked ? 'Synchronized (Safe)' : 'No Lock (Unsafe)'}
          </button>
        </div>
      ...
      <div className="flex-1 bg-white p-4 md:p-8 rounded-xl border border-gray-200 shadow-sm flex flex-col items-center justify-center relative">
        ...
        <div className="mb-12 relative">
           ...
           >
             ...
             <div className="text-sm text-gray-500 mt-1">Shared Count</div>
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-20 w-full justify-center items-center">
          ...
          >
            <div className="font-bold text-blue-600 mb-2">Thread 1</div>
          ...
          >
            <div className="font-bold text-yellow-600 mb-2">Thread 2</div>
            <div className="text-xs text-gray-500">Executing...</div>
          </motion.div>
        </div>
        ...
        {!isRunning && count > 0 && (
          <div className={`mt-8 px-6 py-3 rounded-lg font-bold ${
            ...
            结果: {count} / 20 {count < 20 ? '(Data Loss!)' : '(Correct)'}
          </div>
        )}
