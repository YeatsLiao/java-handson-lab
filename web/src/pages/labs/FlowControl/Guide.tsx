...
const GuideZh: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">for 循环的执行顺序</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
        标准的 for 循环 <code>for (init; condition; update)</code> 执行步骤如下：
      </p>
      <ol className="list-decimal list-inside text-gray-600 dark:text-gray-400 space-y-2 mb-4 bg-gray-50 dark:bg-gray-900 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Execution Order of for Loop</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-4">
