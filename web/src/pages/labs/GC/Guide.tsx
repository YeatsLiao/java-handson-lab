...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Java Heap Memory Structure</h3>
      <p className="text-gray-600 mb-4">
        To optimize garbage collection efficiency, the JVM divides heap memory into different generations:
      </p>
      <div className="flex gap-4 mb-4">
         <div className="flex-1 border p-2 rounded bg-green-50">
           <div className="font-bold text-center">Young Generation</div>
           <div className="flex gap-2 mt-2 text-xs text-center">
             <div className="flex-1 bg-green-200 p-1 rounded">Eden</div>
             <div className="w-1/4 bg-green-300 p-1 rounded">S0</div>
             <div className="w-1/4 bg-green-300 p-1 rounded">S1</div>
         ...
         <div className="flex-1 border p-2 rounded bg-blue-50">
           <div className="font-bold text-center">Old Generation</div>
           <div className="mt-2 bg-blue-200 p-1 rounded h-6 text-xs text-center">Tenured</div>
         </div>
      </div>
    </section>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">GC Process (Minor GC)</h3>
      <ol className="list-decimal list-inside text-gray-600 space-y-2 mb-4">
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Object Reachability</h3>
      <p className="text-gray-600 mb-4">
