...
const GuideEn: React.FC = () => (
  <div className="space-y-6">
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Java's 8 Primitive Types</h3>
      <p className="text-gray-600 mb-4">
        ...
        <table className="min-w-full text-sm">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="p-3 text-left font-semibold text-gray-600">Size (Bit)</th>
              <th className="p-3 text-left font-semibold text-gray-600">Range / Description</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-100">
            <tr>
    ...
    <section>
      <h3 className="text-xl font-bold text-gray-800 mb-3">Stack Memory</h3>
      <p className="text-gray-600">
